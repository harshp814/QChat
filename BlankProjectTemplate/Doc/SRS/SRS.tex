...
The purpose of our project is to allow students who are nervous to ask questions in large lecture rooms to have a voice through an anonymous platform by providing a cross platform Q and A (what is Q and A?) app. The app will allow users to anonymously post questions. Users will be able to upvote questions they would like to find the answers to and the most popular questions will be showed at the top for the professor to answer.

\subsection{The Stakeholders}
% just refer to yourselves as QChat Team, or the Team, or Group 14
...
\\
\\
\textbf{Description:} The app will only run when connected to internet % word this differently, like the application needs a stable internet connection
\\
...
For the app to run some of the Off-the-Shelf software that it will use are, a web browser, JavaScript and a device like phone, computer etc. where the web browser can run.
  ...
  \item The application should be available for free to all users. % why is this a constraint?
\end{itemize}
...
\begin{itemize}
    ...
    \item Users will be respectful to each other while using the app and will not use the anonymous feature to bully or troll the chat room. Such posts will be deleted. % provide details on what trolling is
\end{itemize}
...
\textbf{Description:} App should allow users to post questions and answers to chatrooms anonymously  % be more atomic
\\
...
\\
\textbf{Fit Criterion:} Check if app runs on Chrome, Mozilla Firefox, Internet Explorer, iOS, Android % is this all browsers / devices though?
\\
\\
\textbf{Description:} User should be able to connect to different chat rooms by giving a unique ID  % how does user get, or system generate IDs?
\\
...
\\
\\
\textbf{Description:} User should be able to upvote questions and answers which will push the questions and answers with most upvotes at the top of the chat % be more atomic, does timing play a role in priority?
\\
\textbf{Rationale:} This will allow professors to easily answer the question that is common among students 
\\
\textbf{Fit Criterion:} Upvote different questions and see if top questions post changes dynamically % be sure to provide definition when using upvote as a verb

\section{Non-functional Requirements}

\subsection{Look and Feel Requirements}
Since the final product is going to be a web application, the product should look visually appealing, so that our users find the product usable. It should look professional to gain user’s trust to make them feel like it's reliable. % when is this satisfied?

\subsection{Usability and Humanity Requirements}
Our web app should have an easy to use interface which is simple and intuitive. It will be easy for our users to understand how to use our app because we will have similar UI and UX as other successful messaging platforms. The app will also provide an ease of access as it will run on an internet browser and will not require the user to download anything. The app will be tested before it is released therefore there will be very minimal to no errors allowing user to have a smooth experience using our app. % <- not a usability requirement
Meaning one month’s use of the product should result in a error rate of less than 1 percent. 
...
QChat is a realtime messaging app because of this a key functionality should be the fact that the app should take less than 3 seconds to load on a web browser. Another performance requirement is there should not be a long lag between posting something to the app and it showing up/updating on all other places. 
% below are not performance requirements
The app will be available for use 24 hours per day, 365 days per year. 
If the app crashes this should not delete the data, data will be safe. The app should not have any glitches when running on different web browsers. For example any UI glitches.

\subsection{Operational and Environmental Requirements}
% choose set of browsers and version numbers
...
% less about team methods, and software techniques
